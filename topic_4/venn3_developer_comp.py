"""
Розглянемо практичну задачу — аналіз компетенцій у розробників.
У нас є команда, і ми хочемо зрозуміти хто якими технологіями володіє.
"""
...
print("Знають лише Python (без JS і SQL):", python_devs - javascript_devs - sql_devs)
