"""
Розглянемо приклад який перевіряє дві прямі — y=2x та y=2x+1. 
Перша пряма проходить через початок координат, а друга ні. 
Для кожної виконаємо перевірку, чи залишаються результати 
додавання та множення на число на самій прямій.
Якщо обидві властивості виконуються, множина векторів утворює підпростір.
"""
