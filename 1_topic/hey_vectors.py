...
"""
При такому оголошенні NumPy не розрізняє вектор-стовпець і вектор-рядок, 
а це може бути критичним для деяких розрахунків. Щоб явно задати вектор-рядок, 
використовуйте np.array([[3, 2]]),а для вектора-стовпця — np.array([[3], [2]]).
"""
